...
- Typed error classes (`NotFoundError`, `ValidationError`, `AIServiceError`) work correctly
...
- `HandoffBanner` appears inside sidebar when Archivist expresses uncertainty
